...
spec=importlib.util.spec_from_file_location('builder',BASE/'cc2_firmware_builder_v3.8.py'); m=importlib.util.module_from_spec(spec);spec.loader.exec_module(m)
def rejected(fn):
 try: fn()
