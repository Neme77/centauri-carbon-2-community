...
4. Attendere il riavvio e verificare versione, accesso SSH(root psw: MTY4ODE2) e componenti come indicato in TEST.md. Usare le proprie credenziali; nessuna password universale è documentata qui.
