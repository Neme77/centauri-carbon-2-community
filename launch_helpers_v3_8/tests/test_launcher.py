...
s=importlib.util.spec_from_file_location('launcher',ROOT/'launch_helpers_v3_8/run_build.py');m=importlib.util.module_from_spec(s);s.loader.exec_module(m)
with tempfile.TemporaryDirectory(prefix='cc2 launch test ') as td:
 r=Path(td)
 builder=r/'cc2_builder_v3_8/cc2_firmware_builder_v3.8.py';builder.parent.mkdir();builder.write_bytes((ROOT/'cc2_builder_v3_8/cc2_firmware_builder_v3.8.py').read_bytes())
