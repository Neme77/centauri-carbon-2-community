...
spec=importlib.util.spec_from_file_location('builder',BASE/'cc2_firmware_builder_v3.7.py');b=importlib.util.module_from_spec(spec);spec.loader.exec_module(b)
def reject(fn):
 try:fn()
